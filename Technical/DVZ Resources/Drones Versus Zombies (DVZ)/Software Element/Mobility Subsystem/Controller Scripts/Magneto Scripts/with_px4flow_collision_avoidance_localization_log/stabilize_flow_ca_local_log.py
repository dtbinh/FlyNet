...
init_pix_battery(master,battery,rate_mavlink)
init_pix_att(master,pix_att,rate_mavlink)
header = header_type()
init_pix_imu(master,pix_imu,rate_mavlink,header)
...
while not rospy.is_shutdown():
	...
	battery = update_pix_battery(master,battery,rate_mavlink)
	pix_att = update_pix_att(master,pix_att,rate_mavlink)
	pix_imu = update_pix_imu(master,pix_imu,rate_mavlink,header)
