...
############################################################################################################
def alt_controller(master,quad,target_alt,alt,current_rc_channels):
...
############################################################################################################
def velocity_controller(master,quad,target_velx_inertial,target_vely_inertial,x,y,inertial_yaw,current_rc_channels):
	# Calculate delta t and set previous time at current time
