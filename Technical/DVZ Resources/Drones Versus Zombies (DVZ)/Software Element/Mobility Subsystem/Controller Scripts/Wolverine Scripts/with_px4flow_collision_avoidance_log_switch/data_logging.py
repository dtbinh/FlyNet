...
############################################################################################################
def write_log(filename,quad,vicon_pos,pix_att,x_map,y_map,z_map,psi_map,flow_alt,current_rc_channels,battery,pix_imu,xdot_body,ydot_body,zdot_map,xddot_body,yddot_body,zddot_map,quality,velocity_x,velocity_y,min_dist,min_range,angle,target_velx_body,target_vely_body,angle_min,angle_max,angle_inc,range_min,range_max,ranges):
	f_log = open(filename,'a+')
	print pix_imu[0]
	print pix_imu[1]
	print pix_imu[2]

	f_log.write("%f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f" % (time.time(), vicon_pos[0], vicon_pos[1], vicon_pos[2], pix_att[0], pix_att[1], pix_att[2], pix_att[3], pix_att[4], pix_att[5], x_map, y_map, z_map, psi_map, quad.filtered_alt, flow_alt, quad.alt_RC_P, quad.alt_RC_I, quad.alt_RC_D, quad.T_send, quad.velx_body, quad.velx_pitch_P, quad.velx_pitch_I, quad.velx_pitch_D, quad.pitch_angle_send, quad.pitch_pwm_send, quad.vely_body, quad.vely_roll_P, quad.vely_roll_I, quad.vely_roll_D, quad.roll_angle_send, quad.roll_pwm_send, quad.target_velx_inertial, quad.target_vely_inertial, quad.target_velx_body, quad.target_vely_body, quad.velx_inertial_send, quad.posx_P, quad.posx_I, quad.posx_D, quad.vely_inertial_send, quad.posy_P, quad.posy_I, quad.posy_D, quad.target_x, quad.target_y, current_rc_channels[0], current_rc_channels[1], current_rc_channels[2], current_rc_channels[3], current_rc_channels[4], current_rc_channels[5], battery[0], battery[1], battery[2], pix_imu[1], pix_imu[2], pix_imu[3], pix_imu[4], pix_imu[5], pix_imu[6], pix_imu[7], pix_imu[8], x_map, y_map, z_map, xdot_body, ydot_body, zdot_map, xddot_body, yddot_body, zddot_map, psi_map, flow_alt, quality, velocity_x, velocity_y, angle_min, angle_max, angle_inc, range_min, range_max, min_dist, min_range, angle, target_velx_body, target_vely_body))
