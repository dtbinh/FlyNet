...
from math import *
from controllers_func_ca_euler_log import *
from pixhawk_func_ca_euler_log import *
from collision_avoidance_func_euler_log import *
from data_logging_euler import *
############################################################################################################
# Logging files
...
(quad, x_map, y_map, z_map, psi_map, xdot_body, ydot_body, zdot_map, xddot_body, yddot_body, zddot_map, psi_map) = init_variables(quad, x_map, y_map, z_map, psi_map, xdot_body, ydot_body, zdot_map, xddot_body, yddot_body, zddot_map)
...
while not rospy.is_shutdown():
	...
	(angle,min_range,target_ca_roll,target_ca_pitch,ca_active_flag) = collision_avoidance_drew(K_drew,min_dist,angle_min,angle_max,angle_increment,range_min,range_max,ranges)
	ca_active_flag = 0
	...
	if ca_active_flag == 1:
		velocity_controller(master,quad,0,0,target_ca_roll,target_ca_pitch,x,y,inertial_yaw,current_rc_channels,ca_active_flag)
	else:
