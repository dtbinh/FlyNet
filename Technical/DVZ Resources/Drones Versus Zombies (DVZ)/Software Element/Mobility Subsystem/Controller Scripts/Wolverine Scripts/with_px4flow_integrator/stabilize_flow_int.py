...
from math import *
from controllers_func_flow_int import *
...
print "PX4Flow ROS Subscriber node initialized..."
...
# Set gains for takeoff controller
quad.alt_K_I_takeoff = 20
...
# Set base RC levels
quad.base_rc_throttle_takeoff = 1600
...
while not rospy.is_shutdown():
	...
	# Call controllers
	if alt <= base_alt and takeoff_flag == 0:
		takeoff_controller(master,quad,base_alt,alt)
	...
	#f_yaw = write_yaw(fname_yaw,f_yaw,yaw,quad,vicon_pos,vicon_orient,flow_alt)
	if write_file == 1:
