...
############################################################################################################
def write_alt_vicon(filename,f_alt,alt,quad,vicon_pos,pix_att,flow_alt):
	f_alt = open(filename,'a+')
	f_alt.write("%f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f\n" % (time.time(), quad.filtered_alt, quad.alt_RC_P, quad.alt_RC_I, quad.alt_RC_D, quad.T_send, vicon_pos[0], vicon_pos[1], flow_alt, pix_att[0], pix_att[1], pix_att[2], quad.target_alt))
	f_alt.close()
	return f_alt
############################################################################################################
