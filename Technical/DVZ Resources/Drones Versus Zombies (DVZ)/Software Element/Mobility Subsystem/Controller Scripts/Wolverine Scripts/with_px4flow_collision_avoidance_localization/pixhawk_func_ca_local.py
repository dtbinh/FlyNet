...
############################################################################################################
def update_pix_time(master,pix_time,rate):
	"""
...
def init_pix_imu(master,pix_imu,rate,header):
	...
	print "xacc <%f>, yacc <%f>, zacc <%f>, xgyro <%f>, ygyro <%f>, zgyro <%f>, xmag <%f>, ymag <%f>, zmag <%f>" % (pix_imu[2], pix_imu[3], pix_imu[4], pix_imu[5], pix_imu[6], pix_imu[7], pix_imu[8], pix_imu[9], pix_imu[10])
	print " "
############################################################################################################

############################################################################################################
def init_pix_time(master,pix_time,rate):
	"""
	...
	while (pix_time[0] == None):
		update_pix_time(master,pix_time,rate)
	print " "
