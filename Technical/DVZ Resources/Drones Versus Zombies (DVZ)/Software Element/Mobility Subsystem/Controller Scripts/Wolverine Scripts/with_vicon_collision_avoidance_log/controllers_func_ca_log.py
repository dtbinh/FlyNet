...
############################################################################################################
def velocity_controller(master,quad,target_velx_inertial,target_vely_inertial,target_velx_body,target_vely_body,x,y,inertial_yaw,current_rc_channels,ca_active_flag):
	# Calculate delta t and set previous time at current time
