...
def alt_controller(master,quad,target_alt,alt,current_rc_channels,zdot_map):
	...
	# Calculate I error
	if math.fabs(quad.error_alt) < quad.I_alt_bounds and current_rc_channels[6] > 1400:
...
def angle2pwm(quad,angle,controller):
	...
	if controller == 'roll':
		radio_trim = 1502		#Wolverine#1629#1631#1597
		radio_max = 2015		#2048#2051#2022
		radio_min = 991			#1195#1188#1164
		dead_zone = 30
	elif controller == 'pitch':
		radio_trim = 1505		#1412#1413#1459
		radio_max = 2016		#1832#1836#1877
		radio_min = 992#		984#978#1107
		dead_zone = 30
	elif controller == 'throttle':
		radio_trim = 992		#1108#1107#1107
		radio_max = 2016		#1929#1929#1929
		radio_min = 990			#1107#1107#1107
		dead_zone = 30
	elif controller == 'yaw':
		radio_trim = 1505		#1554#1555#1558
		radio_max = 2017		#1978#1983#1984
		radio_min = 992			#1124#1122#1125
		dead_zone = 40
