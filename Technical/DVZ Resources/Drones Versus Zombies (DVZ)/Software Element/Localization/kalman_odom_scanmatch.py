...
R_hawk = diag([16.19, 7.81, 28.76, 2e-9, 2e-9, 2e-9])

#Converts acceleration variance to metric
R_hawk[0] *= (9.81/1000)**2
R_hawk[1] *= (9.81/1000)**2
R_hawk[2] *= (9.81/1000)**2

#State covariance matrix
P = diag([10, 10, 4, 4, 4, 4, 16.19*(9.81/1000)**2, 7.81*(9.81/1000)**2, 28.76*(9.81/1000)**2])
...
acc = zeros(3) #[x_ddot, y_ddot, z_ddot]
