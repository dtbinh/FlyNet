...
log.hokuyo_angle_min = data(:,79);
log.hokuyo_angle_max = data(:,80);
log.hokuyo_angle_increment = data(:,81);
log.hokuyo_range_min = data(:,82);
log.hokuyo_range_max = data(:,83);
log.hokuyo_min_dist = data(:,84);
log.hokuyo_min_range = data(:,85);
